...
{
    public class MessageBusSubscriberAppointmentCreatedEvent : BackgroundService
    {
        ...
        public MessageBusSubscriberAppointmentCreatedEvent(IConfiguration configuration, IServiceScopeFactory scopeFactory)
        {
        ...
        protected override Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            consumer.Received += (ModuleHandle, ea) =>
            {
                ...
                using (var scope = _scopeFactory.CreateScope())
                {
                    ...
                    specialistManager.AppointmentCreated(appointment, appointment.PeopleInvited.Where(x => x is Specialist).Select(x => (Specialist) x).ToList());
                }
            };
