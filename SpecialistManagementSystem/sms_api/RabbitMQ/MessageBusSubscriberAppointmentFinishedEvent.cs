...
{
    public class MessageBusSubscriberAppointmentFinishedEvent : BackgroundService
    {
        ...
        public MessageBusSubscriberAppointmentFinishedEvent(IConfiguration configuration, IServiceScopeFactory scopeFactory)
        {
        ...
        private void InitializeRabbitMQ()
        {
            ...
            _channel.QueueBind(queue: _queueName,
                exchange: "trigger",
                routingKey: "AppointmentFinishedEvent");
